...
def create_complete_buildings(clean_buildings, centroids_gdf, tessellation):
    ...
    Returns:
    GeoDataFrame
        A merged GeoDataFrame containing all building, centroid, and tessellation data
    """
...
def create_joined_gdf(clean_buildings, centroids_gdf, tessellation):
    ...
    Returns:
    GeoDataFrame
        A joined GeoDataFrame containing all building, centroid, and tessellation data
    """
